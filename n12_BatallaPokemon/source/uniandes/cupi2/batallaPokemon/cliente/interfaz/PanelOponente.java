...
/**
 * Panel con la información de batalla del oponente.
 */
public class PanelOponente extends JPanel
{
    ...
    /**
     * Etiqueta con la imagen del pokémon seleccionado.
     */
    ...
    /**
     * Panel con los pokémon seleccionados por el oponente.
     */
     ...
     * @param pPokemonesDebilitados Cantidad de pokémon que tiene salud en cero. pPokemonesDebilitados >=0.
     * @param pPokemonSeleccionado Pokémon seleccionado por el oponente. pokemonSeleccionado != null.
     * @param pImagen Imagen del avatar del oponente. pImagen !=null.
     */
    public void actualizar( int pPokemonesDebilitados, Pokemon pPokemonSeleccionado, String pImagen )
    {
        ...
        etiquetaImagenPokemonSeleccionado.setIcon( new ImageIcon( RUTA + pPokemonSeleccionado.darNombre( ) + "Oponente.PNG" ) );
