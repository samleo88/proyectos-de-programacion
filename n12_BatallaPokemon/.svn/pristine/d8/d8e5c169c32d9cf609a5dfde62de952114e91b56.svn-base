 ...
 * <b>inv:</b><br>
 * pokemonesJugador != null. No puede haber dos pokémon con el mismo nombre.
 */
public class Jugador
{
    ...
    /**
     * Retorna una cadena con la información del jugador.
     ...
     * No existen dos pokémon con el mismo nombre. <br>
     */
