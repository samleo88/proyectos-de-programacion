...
/**
 * Diálogo que muestra las opciones iniciales de un jugador.
 */
public class DialogoInicioJugador extends JDialog implements ActionListener
{
    ...
    /**
     * Construye un nuevo diálogo de inicio.
     * @param pInterfazCliente Referencia a la ventana principal. pInterfazCliente != null
     */
    public DialogoInicioJugador( InterfazBatallaPokemon pInterfazCliente )
    {
