...
public class InterfazBatallaPokemon extends JFrame implements WindowListener
{
    ...
    /**
     * Panel donde se visualiza la batalla pokémon.
     */
     ...
     */
    private DialogoSeleccionarPokemones dialogoSeleccionarPokemon;
    ...
    {
        dialogoSeleccionarPokemon = new DialogoSeleccionarPokemones( this, batalla.darPokemonDisponibles( ) );
        dialogoSeleccionarPokemon.addWindowListener( this );
        dialogoSeleccionarPokemon.setVisible( true );
     ...
     */
    public void ingresarPokemonSeleccionados( ArrayList pPokemonSeleccionados )
    {
