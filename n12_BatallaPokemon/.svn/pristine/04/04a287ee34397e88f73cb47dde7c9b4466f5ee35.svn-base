...
public class Pokemon implements Cloneable
{
    ...
    {
        assert ( tipo.equals(  TIPO_FUEGO) || tipo.equals( TIPO_AGUA) || tipo.equals( TIPO_PLANTA) || tipo.equals(TIPO_ELECTRICO) || tipo.equals( TIPO_ROCA) || tipo.equals(TIPO_VOLADOR) ) : "El tipo no es válido";
